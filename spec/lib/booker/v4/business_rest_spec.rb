...
describe Booker::V4::BusinessREST do
  ...
  describe '#find_customers' do
    ...
    context 'other options' do
      ...
      it 'adds other options passed in to the params' do
        expect(client.find_customers(booker_location_id: booker_location_id, options: {another_option: 'foo'})).to eq []
      end
    end
  end
  ...
  describe '#find_appointments' do
    ...
    context 'other options' do
      ...
      it 'adds other options passed in to the params' do
        expect(client.find_appointments(booker_location_id: booker_location_id, start_date: from_start_date, end_date: to_start_date, options: {another_option: 'foo'})).to eq []
      end
    end
  end
